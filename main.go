...
func main() {
	...
	bireysel := ScoreCalculationModules.ModelWithInteractionPointOfView{ScoringCalculationHashMap: BKRSkorHesaplamaVerisi, ModelStructureInfo: BireyselModelYapiVerisi, ScaleInfo: BKROlcekSecenekVerisi, InteractionInfo: BKREtkilesimVerisi, SegmentationInfo: SegmentasyonVerisi, ModelAdditionalInfo: BKRModelVerisi}
...
func main() {
	...
	modelStructureInfo := []utils.ModelStructure{
		{Name: "Err Counter Control", CriterionId: "1", Structure: "...1", Weight: 100, CriterionScaleLimit: "U", CriterionFormula: utils.FormulaStructure{}},
		{Name: "CPU Rate Control", CriterionId: "2", Structure: "...2", Weight: 100, CriterionScaleLimit: "U", CriterionFormula: utils.FormulaStructure{}},
		{Name: "RAM Control", CriterionId: "3", Structure: "...3", Weight: 100, CriterionScaleLimit: "U", CriterionFormula: utils.FormulaStructure{}},
		{Name: "Memory limit Control", CriterionId: "4", Structure: "...4", Weight: 100, CriterionScaleLimit: "U", CriterionFormula: utils.FormulaStructure{}},
	}

	interactionInfo := []utils.InteractionStructure{
		{InteractionId: 1, PriorityOrderNum: 1, InteractionType: 9, EffectedCriterionId: "1", InteractionBehaviourType: 3, FormulaList: []utils.FormulaStructure{{FormulaPriorityNum: 1, Formula: "([Last_Err_Counter] * [Multiplier_Err_Counter]) < [New_Err_Counter] ", Result: "-1"}}},
		{InteractionId: 2, PriorityOrderNum: 2, InteractionType: 9, EffectedCriterionId: "2", InteractionBehaviourType: 3, FormulaList: []utils.FormulaStructure{{FormulaPriorityNum: 1, Formula: "[CPU_Rate] >= [CPU_Rate_Limit]", Result: "-1"}}},
		{InteractionId: 3, PriorityOrderNum: 3, InteractionType: 9, EffectedCriterionId: "3", InteractionBehaviourType: 3, FormulaList: []utils.FormulaStructure{{FormulaPriorityNum: 1, Formula: "[RAM] >= [RAM_Limit]", Result: "-1"}}},
		{InteractionId: 4, PriorityOrderNum: 4, InteractionType: 9, EffectedCriterionId: "4", InteractionBehaviourType: 3, FormulaList: []utils.FormulaStructure{{FormulaPriorityNum: 1, Formula: "[Memory] >= [Memory_Limit]", Result: "-1"}}},
	}
	modelAdditionalInfo := utils.ModelAdditionalInfoStructure{
		ModelId:                       45,
		SegmentationLimit:             "U",
	...
	scoring := ScoreCalculationModules.ModelWithInteractionPointOfView{
		ScoringCalculationHashMap: scoringCalculationHashMap,
		ModelStructureInfo:        modelStructureInfo,
		InteractionInfo:           interactionInfo,
		ModelAdditionalInfo:       modelAdditionalInfo}
	...
	if err == nil {
		...
		skorHesaplamaOutput := SkorHesaplamaOutput{ModelTreeDataStructure: model.CreateModelLogTree(), InteractionTreeDataStructure: model.CreateInteractionLogTree()}
		mapB, _ := json.Marshal(skorHesaplamaOutput)
		fmt.Println(string(mapB))
	} else {
		fmt.Println(err)
